...
# 설치
## [Mac용 Visual Studio 2019 설치](installation.md)
...
# IDE 사용자 지정
## [IDE의 모양과 느낌 사용자 지정](customizing-the-ide.md)
## [Mac용 Visual Studio 확장](extending-visual-studio-mac.md)

# 프로젝트 및 솔루션
## [개요](projects-and-solutions.md)
...
# 웹앱 배포
## [개요](web-app-deployment.md)
## [Azure App Service에 게시](publish-app-svc.md)
## [폴더에 게시](publish-folder.md)

# 작업
## [사용 가능한 워크로드](workloads.md)
## ASP.NET Core
### [.NET Core 지원](net-core-support.md)
### [첫 번째 ASP.NET Core 앱 빌드](asp-net-core.md)
### [Razor](razor.md)
