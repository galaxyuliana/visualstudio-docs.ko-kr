...
ms.locfileid: "55140704"
---
# <a name="debugging-apps-in-a-local-docker-container"></a>로컬 Docker 컨테이너에서 앱 디버그
## <a name="overview"></a>개요
Visual Studio 2017은 Docker 컨테이너에서 로컬로 애플리케이션을 개발하고 유효성을 검사하는 일관된 방법을 제공합니다.
...
6. Visual Studio로 전환하여 중단점을 보고, 메시지의 값을 검사합니다.
   ...
   ![중단점](media/vs-azure-tools-docker-edit-and-refresh/breakpoint.png)
