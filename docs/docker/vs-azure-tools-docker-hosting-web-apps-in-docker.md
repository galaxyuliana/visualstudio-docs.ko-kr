...
4. **새 Azure Container Registry 만들기**에 원하는 값을 채웁니다.
    ...
    ![Visual Studio의 Azure Container Registry 만들기 대화 상자](media/vs-azure-tools-docker-hosting-web-apps-in-docker/vs-acr-provisioning-dialog.png)
