...
이 문서에는 Visual Studio 2017 이상(이전 버전과 유사하지만 몇 가지 차이점이 있음)에서 프로젝트 템플릿 및 기타 지원에 대한 세부 정보가 포함되어 있습니다. Python에서 Azure로 작업하는 방법에 대한 자세한 내용은 [Azure Python 개발자 센터](https://docs.microsoft.com/python/azure/?view=azure-python/?view=azure-python)(영문)를 참조하세요.
