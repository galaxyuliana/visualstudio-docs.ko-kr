...
|단락 표시를 포함하지 않고 단락을 선택하고 텍스트를 이동합니다.|[방법: 프로그래밍 방식으로 제외 단락 표시 범위를 만들 때](../vsto/how-to-programmatically-exclude-paragraph-marks-when-creating-ranges.md)|  
...
|범위의 텍스트에 서식을 지정합니다.|[방법: 문서에서 프로그래밍 방식으로 텍스트 서식 지정](../vsto/how-to-programmatically-format-text-in-documents.md)|  
