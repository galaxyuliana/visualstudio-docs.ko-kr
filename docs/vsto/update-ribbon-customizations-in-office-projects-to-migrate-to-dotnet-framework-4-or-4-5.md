...
<CodeContentPlaceHolder>11</CodeContentPlaceHolder> 다음 표에 컨트롤을 프로그래밍 방식으로 만들 수 있습니다 및 메서드를 대상으로 하는 프로젝트에서 컨트롤을 만드는 데는 [!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)] 이상.

|Control|[!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)] 이상 프로젝트에서 사용할 RibbonFactory 메서드|
|-------------| - |
