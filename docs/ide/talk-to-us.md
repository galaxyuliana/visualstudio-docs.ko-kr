...
페이지 아래쪽의 **이 페이지가 도움이 되었나요?** 피드백 단추를 사용하세요. 이 단추는 모든 설명서 페이지에 있습니다. 또는 GitHub 계정을 사용하여 [docs.microsoft.com](https://docs.microsoft.com/visualstudio/)의 모든 Visual Studio 페이지에 피드백을 추가할 수 있습니다. 페이지 맨 아래에 있는 **피드백 정보 보내기** > **이 페이지** 단추를 선택합니다.
