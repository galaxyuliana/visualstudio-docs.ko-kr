...
ms.locfileid: "65531596"
---
# <a name="how-to-use-the-keyboard-exclusively"></a>방법: 단독으로 키보드 사용

바로 가기 키를 사용하면 Visual Studio IDE를 쉽게 탐색하고 코딩할 수 있습니다. 바로 가기 키를 보다 효율적으로 사용할 수 있는 몇 가지 방법을 살펴보겠습니다.

Visual Studio에서 바로 가기 키의 전체 목록을 보려면 [기본 바로 가기 키](../../ide/default-keyboard-shortcuts-in-visual-studio.md)를 참조하세요. 다른 Microsoft 제품에 사용 가능한 바로 가기 키에 대한 자세한 내용은 [https://www.microsoft.com/accessibility/](http://go.microsoft.com/fwlink/?LinkID=40400)을 참조하세요.
...
2. **Ctrl+위쪽 화살표** 또는 **Ctrl+아래쪽 화살표** 바로 가기 키를 사용하여 **도구 상자** 탭의 섹션 간에 이동합니다.

3. **위쪽 화살표** 키 또는 **아래쪽 화살표** 키를 사용하여 컨트롤 간에 이동합니다.

4. 컨트롤을 선택한 후 **Enter** 키를 사용합니다.

   Visual Studio는 폼 또는 디자이너에 컨트롤을 추가합니다.
...
키보드를 사용하여 열린 도구와 문서 창 사이를 이동할 수 있는 몇 가지 방법이 있습니다. 키보드를 사용하여 다른 위치에서 도구 창을 이동 및 도킹할 수도 있습니다.
...
3. **Alt**+**스페이스바** 바로 가기 키를 사용한 다음, **이동**을 선택합니다.
