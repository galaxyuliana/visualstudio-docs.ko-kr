...
ms.locfileid: "62790943"
---
# <a name="options-dialog-box-environment"></a>옵션 대화 상자: 환경

**옵션** 대화 상자의 **환경** 폴더에 있는 페이지를 사용하여 IDE(통합 개발 환경)에서 특정 요소의 표시 및 작동 방법을 설정할 수 있습니다. **도구** > **옵션**을 선택한 다음, **환경**을 선택하여 환경 페이지에 액세스할 수 있습니다.

|자세한 방법|참조|
| - |---------|
|IDE의 창, 메뉴 및 기타 요소의 모양과 동작을 사용자 지정합니다.|[옵션 대화 상자, 환경, 일반](../../ide/reference/general-environment-options-dialog-box.md)|
|컴퓨터 간에 설정을 로밍할지 여부를 지정합니다.|[옵션 대화 상자, 환경, 계정](../../ide/reference/accounts-environment-options-dialog-box.md)|
