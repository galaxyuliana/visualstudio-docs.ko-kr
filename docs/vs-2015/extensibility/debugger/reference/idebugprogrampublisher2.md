...
## <a name="example"></a>예제  
 이 예제 프로그램 게시자를 인스턴스화하고 프로그램 노드를 등록 하는 방법을 보여 줍니다. 이 자습서에서 가져온 것 [프로그램 노드 게시](http://msdn.microsoft.com/d0100e02-4e2b-4e72-9e90-f7bc11777bae)합니다.  
