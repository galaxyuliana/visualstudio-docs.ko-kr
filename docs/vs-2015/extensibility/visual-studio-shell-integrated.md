...
|편집기|-코드 (통합된 찾기, 원본 정의 inheritance) 도구를 검색 합니다.<br />코드 탐색<br />-   IntelliSense<br />-   SmartTags<br />-리팩터링<br />-깔끔한 목록<br />IntelliSense 필터링<br />-   **코드 정의** 창|  
