...
|메서드|설명|  
|------------|-----------------|  
|[IOleCommandTarget](/windows/desktop/api/docobj/nn-docobj-iolecommandtarget)|표준 OLE 인터페이스입니다. 실행 취소/다시 실행 버퍼에 처리에 주로 사용 됩니다.|  
...
## <a name="see-also"></a>참고 항목  
 ...
 [그림 편집](http://msdn.microsoft.com/f08872bd-fd9c-4e36-8cf2-a2a2622ef986)
