...
|편집기/디자이너|코드 검색 도구 (통합된 찾기, 원본 정의 상속)<br /><br /> IntelliSense<br /><br /> SmartTags<br /><br /> 코드 조각 관리자<br /><br /> 코드 조각<br /><br /> 리팩터링<br /><br /> 멋진 목록<br /><br /> IntelliSense 필터링<br /><br /> 코드 정의 창<br /><br /> 응용 프로그램 디자이너<br /><br /> Windows Forms 디자이너<br /><br /> Windows Presentation Foundation (WPF) 디자이너|  
