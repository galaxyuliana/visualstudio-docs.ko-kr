...
|**디버거:** 디버깅 작업 활동을 모니터링 하는 특정 windows 그룹|즉시||
...
|Shift + 끌기|Source|원래 항목에 대 한 참조를 삭제|끌어 놓기 없음|
...
|Shift + 끌기|Source|원래 항목에 대 한 참조를 삭제|원래 위치에서 항목을 삭제합니다.|
