...
warning C28113: Interlocked 함수를 통해 로컬 변수에 액세스합니다.  
 ...
 드라이버를 사용 하는 Interlocked executive 지원 루틴을 같은 [InterlockedDecrement](https://msdn.microsoft.com/library/windows/hardware/ff547871.aspx), 로컬 변수에 액세스 합니다.  
