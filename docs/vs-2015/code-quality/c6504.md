...
경고 C6504: 주석이 잘못 되었습니다: 속성 포인터, 멤버에 대 한 포인터 또는 배열 형식의 값에만 사용할 수 있습니다  
 ...
 이 경고는 호환 되지 않는 데이터 형식에서 속성의 사용을 나타냅니다. 속성에서 지 원하는 데이터 형식에 대 한 자세한 내용은 참조 하세요. [주석 속성](https://msdn.microsoft.com/f77b4370-6bda-4294-bd2a-e7d0df182a3d)합니다.  
