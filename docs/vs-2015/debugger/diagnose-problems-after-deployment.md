...
1. [빌드 정의 편집 하거나 새 빌드 정의 만듭니다.](https://msdn.microsoft.com/library/1c2eca2d-9a65-477e-9b23-0678ff7882ee)  
...
5. 사용자 지정 템플릿을 사용하는 경우 이 MSBuild 인수를 추가하여 기호 파일을 저장할 위치를 지정합니다.  
    ...
    **/p:BuildSymbolStorePath=**\<*기호 경로*>  
    ...
    ![빌드 정의에 빌드 서버 정보 포함 TFS 2013](../debugger/media/ffr-tfs2013builddefincludeserverinfo.png "FFR_TFS2013BuildDefIncludeServerInfo")  
...
- [이 코드에 대한 자세한 정보를 알아봅니다](../ide/find-code-changes-and-other-history-with-codelens.md). 편집기에서 CodeLens 표시기를 사용하여(편집기를 종료하지 않고) 이 코드에 대한 참조, 변경 기록, 관련 버그, 작업 항목, 코드 검토 또는 단위 테스트를 찾아 볼 수 있습니다.  
     ...
     ![CodeLens &#45; 이 코드에 대한 변경 기록 보기](../debugger/media/ffr-itsummarypageperformancecodelensauthors.png "FFR_ITSummaryPagePerformanceCodeLensAuthors")  
...
- **빌드**  
  ...
  - **BuildLabel** (TeamBuild 용): 빌드 이름 및 번호입니다. 이 레이블은 배포 이벤트의 이름으로도 사용됩니다. 빌드 번호에 대한 자세한 내용은 [빌드 번호를 사용하여 완료된 빌드에 의미 있는 이름 지정](https://msdn.microsoft.com/library/1f302e9d-4b0a-40b5-8009-b69ca6f988c3)을 참조하세요.  
