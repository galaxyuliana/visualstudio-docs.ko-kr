...
## <a name="BKMK_Win32_Projects"></a> Win32 프로젝트  
 ...
 다음은 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 내에서 Win32 프로젝트를 디버깅하는 방법을 보여 주는 절차입니다. [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 외부에서 애플리케이션을 시작하고 여기에 연결하는 방법으로 Win32 애플리케이션을 디버깅할 수도 있습니다. 자세한 내용은 [실행 중인 프로세스에 연결](../debugger/attach-to-running-processes-with-the-visual-studio-debugger.md)합니다.  
