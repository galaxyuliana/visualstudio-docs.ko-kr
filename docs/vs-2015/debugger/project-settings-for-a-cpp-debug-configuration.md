...
|**원격 서버 이름**(원격 Windows 디버거)|응용 프로그램을 디버깅할 다른 컴퓨터의 이름을 지정합니다.<br /><br /> RemoteMachine 빌드 매크로이 속성의 값으로 설정 자세한 내용은 [빌드 명령 및 속성 매크로](https://msdn.microsoft.com/library/239bd708-2ea9-4687-b264-043f1febf98b)합니다.|  
