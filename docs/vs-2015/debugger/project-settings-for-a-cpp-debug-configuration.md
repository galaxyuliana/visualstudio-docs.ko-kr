...
|**원격 서버 이름**(원격 Windows 디버거)|응용 프로그램을 디버깅할 다른 컴퓨터의 이름을 지정합니다.<br /><br /> RemoteMachine 빌드 매크로이 속성의 값으로 설정 자세한 내용은 [빌드 명령 및 속성 매크로](http://msdn.microsoft.com/library/239bd708-2ea9-4687-b264-043f1febf98b)합니다.|  
...
|**SQL 디버깅**(MPI 클러스터 디버거를 제외한 모든 디버거)|[!INCLUDE[vcprvc](../includes/vcprvc-md.md)] 응용 프로그램에서 SQL 프로시저를 디버깅할 수 있습니다. 기본 설정은 아니요입니다.|  
...
|설정|설명|  
|-------------|-----------------|  
|**디버그 정보 생성**([/DEBUG](http://msdn.microsoft.com/library/1af389ae-3f8b-4d76-a087-1cdf861e9103))|/Z7, /Zd, Zi 또는 /ZI로 지정된 형식의 디버그 정보를 포함하도록 링커에 지시합니다.|  
