...
ms.locfileid: "58985785"
---
# <a name="debugbreak-and-debugbreak"></a>DebugBreak 및 __debugbreak
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

코드의 어떤 위치에서든 DebugBreak Win32 함수 또는 [__debugbreak](http://msdn.microsoft.com/library/1d1e1c0c-891a-4613-ae4b-d790094ba830) 내장 함수를 호출할 수 있습니다. `DebugBreak` 및 `__debugbreak`는 해당 위치에 중단점을 설정하는 것과 같은 효과가 있습니다.  
