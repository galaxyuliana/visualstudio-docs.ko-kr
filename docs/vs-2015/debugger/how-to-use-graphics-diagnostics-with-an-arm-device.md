...
> [!IMPORTANT]
> Windows Phone 8.1 디바이스의 경우 개발용으로 사용자의 휴대폰을 등록해야 할 수 있습니다. 그렇게 하려면 등록된 개발자여야 합니다. 자세한 내용은 [배포 및 Windows Phone 8 용 앱을 실행 하는 방법을](https://msdn.microsoft.com/library/windowsphone/develop/ff402565.aspx)합니다.  
