...
|**애플리케이션 통계 수집:** 샘플링 메서드를 사용하여 성능 통계를 수집합니다. 샘플링 데이터는 CPU 사용량 문제를 분석하고 애플리케이션의 일반적인 성능 특성을 이해하는 데 유용합니다.|-   [샘플링을 사용하여 응용 프로그램 통계 수집](../profiling/collecting-application-statistics-for-aspnet-web-applications-using-the-profiler-sampling-method-from-the-command-line.md)|  
