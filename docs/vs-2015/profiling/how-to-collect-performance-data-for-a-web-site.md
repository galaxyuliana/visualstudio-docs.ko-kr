...
ms.locfileid: "54766154"
---
# <a name="how-to-collect-performance-data-for-a-web-site"></a>방법: 웹 사이트에 대한 성능 데이터 수집
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

**웹 애플리케이션에 대한 성능 데이터를 수집하려면** 성능 마법사 [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] 를 사용할 수 있습니다. [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]에 열려 있는 웹 애플리케이션을 프로파일링하거나, 로컬 컴퓨터에 있고 [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] IDE에 열려 있지 않은 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 웹 사이트를 프로파일링할 수 있습니다.  
