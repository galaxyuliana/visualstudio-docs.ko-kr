...
## <a name="launch"></a>Launch  
 ...
 자세한 내용은 [방법: 시작할 이진 파일 지정](../profiling/how-to-specify-the-binary-to-start.md)  
...
## <a name="windows-counters"></a>Windows 카운터  
 ...
 자세한 내용은 [방법: Windows 카운터 데이터 수집](../profiling/how-to-collect-windows-counter-data.md)합니다.  
