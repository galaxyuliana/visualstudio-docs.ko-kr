---
title: '방법: Profiler는 명령줄을 사용 하 여 응용 프로그램 통계를 수집 하는.NET 서비스에 연결 | Microsoft Docs'
ms.date: 11/15/2016
...
ms.locfileid: "63433623"
---
# <a name="how-to-attach-the-profiler-to-a-net-service-to-collect-application-statistics-by-using-the-command-line"></a>방법: 명령줄을 사용 하 여 응용 프로그램 통계를 수집 하는.NET 서비스에는 Profiler 연결
