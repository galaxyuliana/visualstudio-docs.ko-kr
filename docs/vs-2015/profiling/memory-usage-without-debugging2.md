...
## <a name="BKMK_Take_snapshots_to_analyze_the_memory_state_of_your_app"></a> 앱의 메모리 상태 스냅샷 만들기  
...
### <a name="BKMK_Memory_Usage_snapshot_views"></a> 메모리 사용량 스냅샷 뷰  
...
### <a name="BKMK_Managed_Heap_tree__Snapshot_details_"></a> 관리되는 힙 트리(스냅샷 정보)  
