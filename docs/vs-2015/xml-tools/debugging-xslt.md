...
ms.locfileid: "65697031"
---
# <a name="debug-xslt"></a>XSLT 디버깅
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Visual Studio 디버거를 사용하여 XSLT를 디버깅할 수 있습니다. 이 디버거에서는 중단점 설정, XSLT 실행 상태 보기 등을 지원합니다. XSLT 디버깅 하는 것은 Visual Studio Professional edition에서 사용할 수 있습니다.  
...
## <a name="related-sections"></a>관련 단원  
 ...
 [XSLT 참조](https://msdn.microsoft.com/678bcd68-cbbb-4be5-9dd2-40f94488a1cf)  
