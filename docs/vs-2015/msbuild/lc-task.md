...
licx 파일에서 .license 파일을 생성하는 LC.exe를 래핑합니다. LC.exe에 대한 자세한 내용은 [Lc.exe(라이선스 컴파일러)](https://msdn.microsoft.com/library/2de803b8-495e-4982-b209-19a72aba0460)를 참조하세요.  
