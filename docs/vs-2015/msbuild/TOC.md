...
#### [방법: 다른 옵션을 사용하여 동일한 소스 파일 빌드](how-to-build-the-same-source-files-with-different-options.md)
...
#### [방법: 증분 방식으로 빌드](how-to-build-incrementally.md)
...
## [연습: 처음부터 MSBuild 프로젝트 파일 만들기](walkthrough-creating-an-msbuild-project-file-from-scratch.md)
