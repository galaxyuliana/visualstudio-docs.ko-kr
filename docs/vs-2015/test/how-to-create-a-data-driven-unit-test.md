...
```  
 ...
 app.config 파일을 사용하면 단위 테스트 자체를 변경하지 않고 데이터 소스의 위치를 변경할 수 있습니다. 만들기 및 app.config 파일을 사용 하는 방법에 대 한 정보를 참조 하세요. [연습: 구성 파일을 사용하여 데이터 원본 정의](../test/walkthrough-using-a-configuration-file-to-define-a-data-source.md)를 참조하세요.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [방법: 단위 테스트 만들기 및 실행](http://msdn.microsoft.com/5e0f43cf-5e51-48e2-9c98-0eb9324bdc48)   
