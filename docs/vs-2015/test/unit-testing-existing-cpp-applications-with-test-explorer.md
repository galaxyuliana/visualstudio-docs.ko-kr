...
2. 테스트 클래스와 메서드를 단위 테스트 코드 파일에 추가합니다. 예를 들어:  
   ...
   자세한 내용은 [테스트 탐색기를 사용하여 네이티브 코드 유닛 테스트](http://msdn.microsoft.com/8a09d6d8-3613-49d8-9ffe-11375ac4736c)를 참조하세요.  
...
2. 테스트 탐색기에서 **모두 실행**을 선택합니다.  
   ...
   자세한 내용은 참조 하세요. [빠른 시작: 테스트 탐색기를 사용한 테스트 기반 개발](../test/quick-start-test-driven-development-with-test-explorer.md)합니다.
