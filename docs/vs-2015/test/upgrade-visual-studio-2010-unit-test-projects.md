...
## <a name="see-also"></a>참고 항목
 [포팅, 마이그레이션 및 Visual Studio 프로젝트를 업그레이드](../porting/porting-migrating-and-upgrading-visual-studio-projects.md) [코드 단위 테스트](../test/unit-test-your-code.md) [이전 버전의 Visual Studio에서 테스트 업그레이드](https://msdn.microsoft.com/e9c8b7f6-bd72-448e-8edb-d090dcc5cf52) [업그레이드에서 코딩 된 UI 테스트 Visual Studio 2010](../test/upgrading-coded-ui-tests-from-visual-studio-2010.md)