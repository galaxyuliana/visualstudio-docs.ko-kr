...
> [!NOTE]
> 저장소 서비스 큐는 Azure Service Bus 큐와 구별됩니다. Service Bus 큐에 대한 자세한 내용은 [Service Bus 큐, 항목 및 구독](/azure/service-bus-messaging/service-bus-queues-topics-subscriptions)을 참조하세요.
...
Azure storage 서비스를 사용 하는 방법에 대 한 자세한 내용은 참조 하세요 [Azure Storage 소개](/azure/storage/common/storage-introduction)합니다.
