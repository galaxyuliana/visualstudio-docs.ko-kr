...
### <a name="working-with-mip-levels"></a>MIP 수준 사용  
 일부 이미지 형식(예: DirectDraw Surface(.dds))은 질감 공간 LOD(세밀도)에 대한 MIP 수준을 지원합니다. MIP 수준을 생성하고 사용하는 방법에 대한 자세한 내용은 [방법: MIP 수준 만들기 및 수정](../designers/how-to-create-and-modify-mip-levels.md)  
