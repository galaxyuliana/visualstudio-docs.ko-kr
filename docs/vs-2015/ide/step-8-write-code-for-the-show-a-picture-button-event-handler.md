...
- 사용자가 그림 파일을 열면 프로그램의 PictureBox에 해당 그림이 표시됩니다.  
  ...
  ![비디오 링크](../data-tools/media/playvideo.gif "PlayVideo")이 항목의 비디오 버전을 참조 하세요. [자습서 1: 비디오 4-Visual Basic에서 사진 뷰어 만들기](http://go.microsoft.com/fwlink/?LinkId=205215) 또는 [자습서 1: 사진 뷰어 만들기 C# -비디오 4](http://go.microsoft.com/fwlink/?LinkId=205203)합니다. 이러한 비디오에서는 이전 버전의 Visual Studio를 사용하므로 일부 메뉴 명령과 기타 사용자 인터페이스 요소가 약간 다를 수 있습니다. 그러나 개념 및 절차는 Visual Studio의 현재 버전에서 비슷하게 작동합니다.  
...
- 다음 자습서 단계로 이동하려면 [9단계: 검토, 주석 처리 하 고 코드를 테스트](../ide/step-9-review-comment-and-test-your-code.md)합니다.  
  
- 이전 자습서 단계로 돌아가려면 [7단계: 폼에 대화 상자 구성 요소를 추가](../ide/step-7-add-dialog-components-to-your-form.md)합니다.
