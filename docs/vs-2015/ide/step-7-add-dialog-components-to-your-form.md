...
- 다음 자습서 단계로 이동하려면 [8단계: 그림 단추 이벤트 처리기 표시를 위한 코드를 작성](../ide/step-8-write-code-for-the-show-a-picture-button-event-handler.md)합니다.  
  
- 이전 자습서 단계로 돌아가려면 [6단계: 단추 컨트롤 이름 지정](../ide/step-6-name-your-button-controls.md)합니다.
