...
1.  사용자 지정 시작 페이지를 설치하는 방법은 다음과 같습니다.
    ...
    -   설치 합니다 [Visual Studio Marketplace](https://marketplace.visualstudio.com/), 다른 웹 사이트 또는 로컬 인트라넷의 페이지입니다.
...
## <a name="see-also"></a>참고 항목
 [Visual Studio에서 개발 설정 사용자 지정](http://msdn.microsoft.com/22c4debb-4e31-47a8-8f19-16f328d7dcd3) [직접 만드는 시작 페이지](../misc/creating-your-own-start-page.md)
