---
title: '1단계: Windows Forms 응용 프로그램 프로젝트 만들기 | Microsoft Docs'
ms.date: 11/15/2016
...
- 다음 자습서 단계로 이동하려면 [2단계: 프로그램 실행](../ide/step-2-run-your-program.md)합니다.  
  
- 개요 항목으로 돌아가려면 [자습서 1: 사진 뷰어 만들기](../ide/tutorial-1-create-a-picture-viewer.md)합니다.
