...
- 다음 자습서 단계로 이동하려면 [3단계: 각 레이블에 임의 아이콘 할당](../ide/step-3-assign-a-random-icon-to-each-label.md)합니다.  
  
- 이전 자습서 단계로 돌아가려면 [1단계: 프로젝트를 만들고 폼에 테이블 추가](../ide/step-1-create-a-project-and-add-a-table-to-your-form.md)합니다.
