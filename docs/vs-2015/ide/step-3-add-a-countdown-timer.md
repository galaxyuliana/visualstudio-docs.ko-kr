---
title: '3단계: 카운트다운 타이머 추가 | Microsoft Docs'
ms.date: 11/15/2016
...
- 다음 자습서 단계로 이동하려면 [4단계: Checktheanswer () 메서드 추가](../ide/step-4-add-the-checktheanswer-parens-method.md)합니다.  
  
- 이전 자습서 단계로 돌아가려면 [2단계: 난수 더하기 문제 만들기](../ide/step-2-create-a-random-addition-problem.md)합니다.
