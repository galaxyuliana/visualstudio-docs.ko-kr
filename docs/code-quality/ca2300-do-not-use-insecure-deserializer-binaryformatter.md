---
title: 'CA2300: 안전 하지 않은 deserializer BinaryFormatter를 사용 하지 마세요'
ms.date: 04/05/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
---
# <a name="ca2300-do-not-use-insecure-deserializer-binaryformatter"></a>CA2300: 안전 하지 않은 deserializer BinaryFormatter를 사용 하지 마세요
