...
ms.locfileid: "68418591"
---
# <a name="warning-c26812-prefer-enum-class-over-enum-enum3"></a>경고가 ' enum ' (Enum C26812) 보다 ' enum class '를 선호 합니다.
열거형 형식% type%은 (는) 범위가 없습니다. ' Enum ' (enum. 3)을 사용 하 여 ' enum 클래스 '를 선호 합니다.
