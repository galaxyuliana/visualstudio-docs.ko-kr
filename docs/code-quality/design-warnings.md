...
ms.locfileid: "66745159"
---
# <a name="design-warnings"></a>디자인 경고

디자인 경고 준수를 지 원하는 합니다 [.NET 디자인 지침](/dotnet/standard/design-guidelines/)합니다.
...
| [CA1003: 제네릭 이벤트 처리기 인스턴스를 사용 합니다.](../code-quality/ca1003-use-generic-event-handler-instances.md) | 대리자는 void를 반환 하며 해당 시그니처에 두 개의 매개 변수 (개체가 첫 번째 및 두 번째는 EventArgs에 할당 될 수 있는 형식)를 포함 하는 형식 및 포함 하는 어셈블리에.NET Framework 2.0만 대상으로 합니다. |
...
| [CA1016: AssemblyVersionAttribute로 어셈블리 표시](../code-quality/ca1016-mark-assemblies-with-assemblyversionattribute.md) | .NET은 어셈블리를 고유 하 게 식별 하 고 강력한 이름의 어셈블리의 형식에 바인딩할 버전 번호를 사용 합니다. 버전 번호는 버전 및 게시자 정책과 함께 사용됩니다. 기본적으로 응용 프로그램은 해당 응용 프로그램이 빌드될 때 사용된 어셈블리 버전으로만 실행됩니다. |
