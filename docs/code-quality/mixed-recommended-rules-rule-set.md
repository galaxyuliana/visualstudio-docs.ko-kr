...
ms.locfileid: "69585324"
---
# <a name="mixed-recommended-rules-rule-set"></a>혼합 권장 규칙 규칙 집합

Microsoft Mixed 권장 규칙은 잠재적 보안 허점, 응용 프로그램 충돌 및 기타 중요 C++ 한 논리 및 디자인 오류를 포함 하 여 공용 언어 런타임을 지 원하는 프로젝트의 가장 일반적이 고 중요 한 문제에 중점을 둡니다. 이 규칙 집합은 [혼합 된 최소 규칙](mixed-minimum-rules-rule-set.md) 규칙 집합의 모든 규칙을 포함 합니다.
