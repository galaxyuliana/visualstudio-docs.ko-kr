...
ms.locfileid: "55907596"
---
# <a name="c6217"></a>C6217

warning C6217: 의미 체계가 다른 정수 형식 간의 암시적 캐스트: 'not'를 사용 하 여 HRESULT를 테스트 합니다. 사용 하는 것이 좋습니다 [SUCCEEDED](/windows/desktop/api/winerror/nf-winerror-succeeded) 하거나 [실패](/windows/desktop/api/winerror/nf-winerror-failed) 매크로 대신 합니다.
