...
## <a name="expose-style-features"></a>스타일 기능을 노출
...
## <a name="forwarding-display-properties-of-related-elements"></a>전달 합니다. 관련 요소의 속성 표시
...
### <a name="add-property-forwarding"></a>추가 속성 전달
...
### <a name="define-a-domain-property-that-has-an-external-type"></a>외부 형식이 있는 도메인 속성 정의
...
### <a name="set-a-property-editor"></a>속성 편집기를 설정 합니다.
...
사용자 고유의 편집기 또는.NET 편집기를를 같이 지정할 수 <xref:System.Windows.Forms.Design.FileNameEditor> 또는 <xref:System.Drawing.Design.ImageEditor>합니다. 예를 들어, 다음 절차를 사용 하 여 사용자 파일 이름을 입력할 수 있는 속성이 있어야 합니다.
...
### <a name="define-your-own-property-editor"></a>사용자 고유의 속성 편집기를 정의 합니다.
...
## <a name="provide-a-drop-down-list-of-values"></a>값의 드롭다운 목록을 제공 합니다.
