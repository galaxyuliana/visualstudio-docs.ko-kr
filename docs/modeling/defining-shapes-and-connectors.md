...
|모양 형식|설명|
|-|-|
|기하 도형|일반적으로 사용되는 사각형 또는 타원형 모양입니다. 모양 경계를 기준으로 특정 위치에 텍스트 및 아이콘 Decorator를 표시할 수 있습니다. 기 하 도형 내 셰이프를 중첩할 수도 있습니다.|
...
## <a name="shape-inheritance"></a>모양 상속
