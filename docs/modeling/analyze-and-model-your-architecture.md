...
종속성 다이어그램에서는 레이어 또는 명시적 종속성을 사용 하 여 블록 집합으로 응용 프로그램의 구조를 정의할 수 있습니다. 라이브 유효성 검사 코드의 종속성과 종속성 다이어그램에 설명 된 종속 간 충돌을 보여 줍니다.
...
DSL은 특정 용도에 맞게 디자인하는 표기법입니다. Visual Studio에서 일반적으로 그래프입니다.
