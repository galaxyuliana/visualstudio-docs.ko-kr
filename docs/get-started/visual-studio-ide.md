...
- [빠른 실행](../ide/reference/quick-launch-environment-options-dialog-box.md)
   ...
   IDE의 오른쪽 위에 있는 **빠른 실행** 검색 상자를 찾을 수 있습니다. (또는 **Ctrl**+**Q**를 눌러 액세스하세요.)
...
8. 스크루드라이버 아이콘을 클릭하면 Visual Studio에서 제안하는 사항을 볼 수 있습니다. 여기에는 전체 동작을 변경하지 않고 코드 줄을 제거할 수 있는 [인라인 임시 변수](../ide/reference/inline-temporary-variable.md) 리팩터링이 표시되어 있습니다.
