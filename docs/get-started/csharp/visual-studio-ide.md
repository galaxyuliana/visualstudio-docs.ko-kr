...
이 개요 문서에서는 간단한 프로젝트를 만들고 코딩 도구로 [IntelliSense](../../ide/using-intellisense.md) 사용, 앱을 디버그하여 프로그램 실행 중 변수 값 확인 및 색 테마 변경과 같은 Visual Studio로 수행할 수 있는 몇 가지 작업을 살펴보겠습니다. 시작하려면 [Visual Studio 2017을 다운로드](https://visualstudio.microsoft.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=inline+link&utm_content=download+vs2017)하여 시스템에 설치합니다.
