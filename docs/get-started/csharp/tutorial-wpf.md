...
1. 새 프로젝트를 만듭니다. 메뉴 모음에서 **파일** > **새로 만들기** > **프로젝트**를 선택합니다.
     ...
     ::: moniker-end
     ::: moniker range=">=vs-2019"
     [메뉴 모음에서 [파일], [새로 만들기], [프로젝트]를 선택합니다.](../media/vs-2019/exploreide-filenewproject-vs2019.png)
     ::: moniker-end

::: moniker range="vs-2017"
2. **새 프로젝트** 대화 상자에서 **설치** > **Visual C#** > **Windows 데스크톱** 범주를 선택한 다음, **WPF 앱(.NET Framework)** 템플릿을 선택합니다. 프로젝트의 이름을 **HelloWPFApp**로 지정하고 **확인**을 선택합니다.
...
2. **새 프로젝트 만들기** 화면에서 “WPF”를 검색하고 **WPF 앱(.NET Framework)**, **다음**을 차례로 선택합니다.
   ...
   ![Visual Studio 새 프로젝트 대화 상자의 WPF 앱 템플릿](media/vs-2019/exploreide-newprojectcsharp-vs2019.png)
