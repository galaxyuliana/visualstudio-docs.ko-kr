...
ms.locfileid: "62786083"
---
# <a name="live-unit-testing-introduction"></a>Live Unit Testing 소개

Live Unit Testing은 Visual Studio 2017에 도입된 기술입니다. 코드를 변경하면 실시간으로 단위 테스트를 자동으로 실행합니다.
...
- 소개 자습서인 [Live Unit Testing 시작](live-unit-testing-start.md)을 살펴보세요.

- 자세한 설명서인 [Visual Studio Enterprise Edition에서 Live Unit Testing 사용](live-unit-testing.md)을 읽어 보세요.
