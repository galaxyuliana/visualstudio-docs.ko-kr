...
2. 스냅숏 디버거를 연결 합니다. 여러 다른 방법 중 하나를 사용할 수 있습니다.
    ...
    * 디버그 대상 드롭다운 메뉴 **스냅숏 디버거**, 적중 횟수 **F5** 계정에 필요한 경우 프로젝트에 배포 된 Azure App Service 및 Azure storage를 선택 하 고 및 클릭  **연결**합니다.
...
이 자습서에서는 App Services에 대 한 스냅숏 디버거를 사용 하는 방법을 알아보았습니다. 이 기능에 대 한 자세한 정보를 보려면 좋습니다.
