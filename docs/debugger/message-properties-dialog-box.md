 ...
 **창 핸들** 이 창의 고유 ID입니다. 창 핸들 번호 다시 사용 됩니다. 해당 창의 기간에만 창을 식별합니다. 이 창의 속성을 보려면이 값을 클릭 합니다.

 **중첩 수준** 여기서 0은 중첩 없이이 메시지의 중첩 수준입니다.

 **메시지** 번호, 상태 및 선택한 windows 메시지의 이름입니다.

 **lResult** 의 값을 *lResult* 있으면 매개 변수입니다.

 **wParam** 의 값을 *wParam* 있으면 매개 변수입니다.

 **lParam** 의 값을 *lParam* 있으면 매개 변수입니다. 이 값은 문자열 또는 구조에 대 한 포인터 이면 디코딩됩니다.
