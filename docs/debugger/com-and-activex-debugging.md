...
## <a name="in-this-section"></a>섹션 내용
 ...
 [방법: ActiveX 컨트롤 디버그](../debugger/how-to-debug-an-activex-control.md) ActiveX 컨트롤 디버깅에 대 한 정보를 포함 합니다. 여기에는 디버그 세션에 사용할 컨테이너를 지정하여 ActiveX 컨트롤 코드의 실행 방식을 확인하는 방법, 데이터 바인딩된 ActiveX 컨트롤의 디버깅, 특정 컨테이너 시뮬레이션, 단계별 컨테이너 코드 실행 등과 관련된 정보가 있습니다.

 [COM 디버깅 도구](../debugger/com-debugging-tools.md) 뷰어 및 COM 응용 프로그램 디버그에 유용할 수 있는 샘플 응용 프로그램을 나열 합니다.

## <a name="related-sections"></a>관련 단원
 [디버거 소개](../debugger/debugger-feature-tour.md) 의 디버깅 설명서 단원에 대 한 링크를 제공 합니다. 디버거의 새로운 기능, 설정 및 준비, 중단점, 예외 처리, 편집하며 계속하기, 관리 코드 디버깅, Visual C++ 프로젝트 디버깅, COM 및 ActiveX 디버깅, DLL 디버깅, SQL 디버깅, 사용자 인터페이스 참조 등의 정보를 다룹니다.
