...
## <a name="use-graphics-diagnostics-with-an-arm-based-device"></a>ARM 기반 장치에서 그래픽 진단 사용
 그래픽 진단을 사용하면 원격 디버깅을 사용하여 ARM 기반 장치에서 Direct3D 앱을 디버깅할 수 있습니다. 자세한 내용은 참조 [방법: ARM 장치를 사용 하 여 그래픽 진단을 사용 하 여](/visualstudio/debugger/graphics/graphics-diagnostics-examples)입니다.
