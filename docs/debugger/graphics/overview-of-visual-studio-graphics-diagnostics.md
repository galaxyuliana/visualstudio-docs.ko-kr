...
### <a name="windows-10-and-direct3d-12"></a>Windows 10 및 Direct3D 12
 ...
 Windows 10에서는 이전 버전의 Direct3D와 이러한 버전을 사용하는 게임 및 애플리케이션에 대한 지원도 유지됩니다. Visual Studio에서 그래픽 진단을 계속 Windows 10에서 Direct3D 10 및 Direct3D 11을 지원 합니다.
