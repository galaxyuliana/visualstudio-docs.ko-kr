...
|![Spy&#43; &#43; 시작 로그 단추](../debugger/media/icon_spy--_startlog.gif "Icon_Spy + + _StartLog")|메시지 로깅을 시작 하 고 메시지 스트림을 표시 합니다. 이 컨트롤은 경우에만 사용할 수는 **메시지** 활성 창입니다. 자세한 내용은 [방법: 메시지 로그 표시 시작 및 중지](../debugger/how-to-start-and-stop-the-message-log-display.md)합니다.|
|![Spy&#43; &#43; 로그 중지 단추](../debugger/media/icon_spy--_stoplog.gif "Icon_Spy + + _StopLog")|중지 메시지 로깅 및 메시지 스트림을 표시 합니다. 이 컨트롤은 경우에만 사용할 수는 **메시지** 활성 창입니다. 자세한 내용은 [방법: 메시지 로그 표시 시작 및 중지](../debugger/how-to-start-and-stop-the-message-log-display.md)합니다.|
...
|![Spy&#43; &#43; 창 찾기 단추](../debugger/media/icon_spy--_findwindow.gif "Icon_Spy + + _FindWindow")|열립니다는 [창 찾기](../debugger/find-window-dialog-box.md) 대화 상자, 창 검색 기준을 설정 하 고 속성이 나 메시지를 표시할 수 있습니다. 자세한 내용은 [방법: 찾기 도구를 사용 하 여](../debugger/how-to-use-the-finder-tool.md)입니다.|
