...
> [!NOTE]
> Visual Studio 2017부터 호스팅 프로세스를 사용 하 여 디버그 하는 옵션은 더 이상 필요 하 고 제거 되었습니다. 자세한 내용은 참조 하세요. [디버깅: 최소 즐겨 찾는 작업 속도를 visual Studio 2017 목표로](https://vslive.com/Blogs/News-and-Tips/2017/02/Debugging-Visual-Studio-2017-aims-to-speed-up-your-least-favorite-job.aspx)합니다.
