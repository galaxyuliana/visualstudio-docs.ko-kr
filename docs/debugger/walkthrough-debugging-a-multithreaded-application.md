...
---
# <a name="view-threads-in-the-visual-studio-debugger-by-using-the-threads-window-c-visual-basic-c"></a>스레드 창을 사용 하 여 Visual Studio 디버거에서 스레드 보기 (C#, Visual Basic, c + +)
...
- **플래그** 이 레이블이 지정 되지 않은 열에서 특별히 주의 하려는 스레드를 표시할 수 있습니다. 스레드에 플래그를 설정 하는 방법에 대 한 정보를 참조 하세요. [방법: 스레드에 플래그 지정 및 해제  
