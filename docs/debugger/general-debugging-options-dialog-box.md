...
**새 예외 도우미를 사용 하 여**: 예외 도우미를 대체 하는 예외 도우미를 사용 하도록 설정 합니다. (예외 도우미는 Visual Studio 2017부터 지원 됩니다.)
...
**레거시를 사용 하 여 C# 및 VB 식 계산기**: 디버거가 Visual Studio 2013을 사용 합니다 C# 또는 Visual Basic 식 계산기 대신 Visual Studio 2015 Roslyn 기반 식 계산기입니다.
...
- **변경 내용 적용 (네이티브 전용)를 계속할 때**: Visual Studio는 자동으로 컴파일 및 프로세스를 계속 하면 중단 상태에서 변경한 모든 미해결 코드 변경 내용을 적용 합니다. 이 옵션을 선택하지 않으면 **디버그** 메뉴에서 **코드 변경 내용 적용** 항목을 사용하여 변경 내용을 적용할 수 있습니다.
