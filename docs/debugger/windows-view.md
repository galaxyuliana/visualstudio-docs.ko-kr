...
## <a name="in-this-section"></a>섹션 내용
 [방법: 찾기 도구를 사용 하 여](../debugger/how-to-use-the-finder-tool.md) 이 도구에서 속성 또는 메시지에 대 한 windows를 검색 하는 방법을 보여 줍니다.

 [방법: Windows 뷰에서 창 검색](../debugger/how-to-search-for-a-window-in-windows-view.md) Windows 보기에서 특정 창을 찾는 방법에 설명 합니다.

 [방법: 창 속성 표시](../debugger/how-to-display-window-properties.md) 창 속성 대화 상자를 열기 위한 프로시저 m입니다.
