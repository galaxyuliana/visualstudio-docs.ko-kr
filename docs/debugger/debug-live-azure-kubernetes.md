...
* Azure Kubernetes Service용 스냅숏 디버거는 **Azure 개발 워크로드**가 포함된 Visual Studio 2019 Enterprise 미리 보기 이상에서만 사용할 수 있습니다. (**개별 구성 요소** 탭의 **디버깅 및 테스트** > **스냅숏 디버거**에서 찾을 수 있습니다.)
