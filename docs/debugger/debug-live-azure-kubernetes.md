...
* Azure Kubernetes Services에 대 한 스냅숏 디버거는 **azure 개발 워크 로드**를 사용 하 여 Visual Studio 2019 Enterprise 이상 에서만 사용할 수 있습니다. (**개별 구성 요소** 탭의 **디버깅 및 테스트** > **스냅샷 디버거**에서 찾을 수 있습니다.)
