...
ms.locfileid: "54940845"
---
# 방법: 목차에서 항목 찾기

**콘텐츠** 탭에서 목차를 사용하여 정보를 찾을 수 있습니다. 목차는 설치된 책의 모든 항목을 포함하는 확장명 가능한 목록입니다. 목차를 탐색하는 방법에 대한 내게 필요한 옵션 정보를 보려면 [바로 가기 키(도움말 뷰어)](../help-viewer/shortcut-keys.md)를 참조하세요.
