...
10. 활성 플랫폼 프로젝트를 가져옵니다. 플랫폼 프로젝트는 플랫폼 특정 코드 및 리소스를 포함 하는 프로젝트입니다. 새 필드를 사용 하는 다음 메서드 <xref:Microsoft.VisualStudio.Shell.Interop.__VSHPROPID7.VSHPROPID_SharedItemContextHierarchy> 활성 플랫폼 프로젝트를 가져오려고 합니다.
