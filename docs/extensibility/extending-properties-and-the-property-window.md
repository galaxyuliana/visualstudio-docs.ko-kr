...
- [속성 창에 속성을 노출](../extensibility/exposing-properties-to-the-properties-window.md) 설명 방식 속성 창에 표시 된 사용자 지정 속성을 사용할 수 있습니다.

- [프로젝트 속성을 가져오는](../extensibility/getting-project-properties.md) 프로젝트 속성을 가져오는 방법에 설명 합니다.