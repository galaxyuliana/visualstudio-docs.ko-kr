...
- [드롭다운 표시줄](../extensibility/drop-down-bar.md) 드롭다운 표시줄을 설명 하 고 구현에 대 한 지침을 제공 합니다.

- [명령 처리](../extensibility/command-handling.md) 세부 정보 명령 편집기에서 처리 합니다.

- [상황에 맞는 메뉴](../extensibility/context-menus.md) 편집기 상황에 맞는 메뉴에 설명 합니다.

- [방법: 상태 표시줄을 업데이트](../extensibility/how-to-update-the-status-bar.md) 업데이트에 대 한 지침을 제공 합니다 **상태 표시줄**합니다.

## <a name="related-sections"></a>관련 단원
- [편집기 및 언어 서비스 확장](../extensibility/editor-and-language-service-extensions.md) 에서는 다양 한 유형의 편집기를 Visual Studio에서 사용할 수 있습니다.