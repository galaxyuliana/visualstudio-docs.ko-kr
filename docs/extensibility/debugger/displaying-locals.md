...
## <a name="in-this-section"></a>단원 내용
 [로컬 항목의 예제 구현은](../../extensibility/debugger/sample-implementation-of-locals.md) 지역 변수를 구현 하는 과정을 단계별로 진행 하는 예제를 사용 합니다.

## <a name="related-sections"></a>관련 단원
 [평가 컨텍스트에](../../extensibility/debugger/evaluation-context.md) 식 계산기 (EE)를 호출 하는 디버그 엔진 (DE)를 통과 하는지 3 개 인수에 설명 합니다.
