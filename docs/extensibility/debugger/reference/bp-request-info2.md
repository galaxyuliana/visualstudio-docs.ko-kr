...
`guidVendor` 공급 업체의 GUID입니다. Null 값이 될 수 있습니다.

`bstrConstraint` 중단점 제약 조건의 이름입니다. Null 값이 될 수 있습니다.

`bstrTracepoint` 추적 지점의 이름입니다. Null 값이 될 수 있습니다.
