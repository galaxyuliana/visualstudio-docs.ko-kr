...
`bstrModuleUrl` 중단점이 포함 된 모듈의 URL입니다.

`bstrFunction` 중단점이 포함 된 함수의 이름입니다.

`bstrAddress` 주소에 바인딩하는 식 계산기에서 구문을 분석 하는 중단점을를 [IDebugAddress](../../../extensibility/debugger/reference/idebugaddress.md) 개체입니다.
