...
#### [일반 정품 구독 활성화](activate-store-subscriptions.md)
#### [링크를](signing-in.md)
##### [ID 대체](vs-alternate-identity.md)
##### [별칭으로 로그인](aliasing.md)
##### [로그인 관련 문제](sign-in-issues.md)
...
#### [Visual Studio Dev Essentials 조인](join-dev-essentials.md)
...
#### [Visual Studio 앱 센터](vs-visual-studio-app-center.md)
...
#### [Xamarin University 학습](vs-xamarin.md)
...
#### [할당 이메일 다시 보내기](resend-assignment-email.md)
...
#### [개인 이메일 로그인을 사용하는 구독자](personal-email-sign-ins.md)
## Visual Studio 구독 취득
...
### [구독 옵션 및 가격 책정 비교](https://visualstudio.microsoft.com/vs/pricing)
...
### [볼륨 라이선스 약관](https://www.microsoft.com/en-us/licensing/product-licensing/products.aspx)
