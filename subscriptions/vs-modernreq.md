...
<sup>1</sup> 포함:  NFR(전매 금지), VSIP(Visual Studio 업계 파트너), Microsoft 파트너 네트워크(Enterprise), FTE,  제외:  Microsoft 파트너 네트워크(Professional), MCT Software & Services Developer, BizSpark, Imagine, MVP(Most Valuable Professional), RD(Regional Director),  MCT 소프트웨어 및 서비스
